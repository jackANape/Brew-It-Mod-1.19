package net.jackanape.brewmod.client;
...
public class ThirstHudOverlay {
    ...
    private static final ResourceLocation FILLED_THIRST = new ResourceLocation(BrewMod.MOD_ID,
            "textures/thirst/filled_thirst.png");
    private static final ResourceLocation EMPTY_THIRST = new ResourceLocation(BrewMod.MOD_ID,
