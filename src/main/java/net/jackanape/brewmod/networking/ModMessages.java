package net.jackanape.brewmod.networking;

import net.jackanape.brewmod.BrewMod;
import net.jackanape.brewmod.networking.packet.DrinkWaterC2SPacket;
import net.jackanape.brewmod.networking.packet.ExampleC2SPacket;
...
public class ModMessages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(BrewMod.MOD_ID, "messages"))
