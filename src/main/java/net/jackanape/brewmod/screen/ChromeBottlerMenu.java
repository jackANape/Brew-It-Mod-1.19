...
public class ChromeBottlerMenu extends AbstractContainerMenu {
    public final ChromeBottlerBlockEntity blockEntity;
    ...
    public ChromeBottlerMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CHROME_BOTTLER_MENU.get(), id);
        checkContainerSize(inv, 3); // match inventory slots down below, check warning!!
        blockEntity = (ChromeBottlerBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.CHROME_BOTTLER.get());
    }
