...
public class ModPlacedFeatures {
    public static final DeferredRegister<PlacedFeature> PLACED_FEATURES =
            DeferredRegister.create(Registry.PLACED_FEATURE_REGISTRY, BrewMod.MOD_ID);

    public static final RegistryObject<PlacedFeature> CHROMIUM_ORE_PLACED = PLACED_FEATURES.register("chromium_ore_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.CHROMIUM_ORE.getHolder().get(),
                    commonOrePlacement(30, // VeinsPerChunk
                            HeightRangePlacement.triangle(VerticalAnchor.absolute(-80), VerticalAnchor.absolute(136)))));
    ...
    public static final RegistryObject<PlacedFeature> NETHER_ORE_PLACED = PLACED_FEATURES.register("nether_zircon_ore_placed",
